...
export const qualityPresets = {
  low: { pixelRatio: 0.55, tileRadius: 1, terrainSegments: 16, chunkBehind: 1, chunkAhead: 2, vegetation: 0.25, fogFar: 180, shadowSize: 0 },
  medium: { pixelRatio: 0.85, tileRadius: 2, terrainSegments: 24, chunkBehind: 1, chunkAhead: 4, vegetation: 0.32, fogFar: 350, shadowSize: 0 },
